...
export const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-hero pt-24 pb-20 md:pt-32 md:pb-24">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl">
          {/* Greeting */}
          <p
            className="font-mono text-primary mb-4 animate-fade-in-up"
          ...
          {/* Title */}
          <h2
            className="text-2xl md:text-4xl lg:text-5xl font-bold text-muted-foreground mb-8 animate-fade-in-up"
          ...
          {/* Description */}
          <p
            className="text-sm md:text-lg text-muted-foreground max-w-2xl mb-12 leading-relaxed animate-fade-in-up"
